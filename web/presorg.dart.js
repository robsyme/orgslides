...
$$.AbstractSlide = {"":
 ["element?", "tocListItem?", "inFunctions?", "outFunctions?"],
 "super": "Object",
 getSecID$0: function() {
  return '#sec-' + $.S($.substring$2(this.element.get$id(), 18, $.get$length(this.element.get$id())));
},
 resetPositionClassTo$1: function(newClassName) {
  if (newClassName === 'current')
    $.forEach(this.inFunctions, new $.AbstractSlide_resetPositionClassTo_anon(this));
  else if ($.contains$1(this.element.get$classes(), newClassName) !== true)
    $.forEach(this.outFunctions, new $.AbstractSlide_resetPositionClassTo_anon0(this));
  for (var t1 = $.iterator(this.classNames); t1.hasNext$0() === true;) {
    var t2 = t1.next$0();
    var t3 = $.eqB(t2, newClassName);
    var t4 = this.element;
    if (t3)
      $.add$1(t4.get$classes(), t2);
    else
      t4.get$classes().remove$1(t2);
  }
},
 AbstractSlide$1: function(ele) {
  this.element = ele;
  this.tocListItem = $.document().query$1('a[href="' + $.S(this.getSecID$0()) + '"]').get$parent();
}
};

$$.SectionSlide = {"":
 ["element", "tocListItem", "classNames", "inFunctions", "outFunctions"],
 "super": "AbstractSlide",
 hideSubsections$0: function() {
  $.forEach(this.element.queryAll$1('.outline-3'), new $.SectionSlide_hideSubsections_anon());
},
 makeFarPast$0: function() {
  this.resetPositionClassTo$1('far-past');
  this.hide$0();
},
 makePast$0: function() {
  this.resetPositionClassTo$1('past');
  this.hide$0();
},
 makeCurrent$0: function() {
  this.hideSubsections$0();
  this.updateTOC$0();
  this.resetPositionClassTo$1('current');
  this.show$0();
},
 makeNext$0: function() {
  this.resetPositionClassTo$1('next');
  this.hide$0();
},
 makeFarNext$0: function() {
  this.resetPositionClassTo$1('far-next');
  this.hide$0();
},
 hide$0: function() {
  $.forEach(this.element.queryAll$1(':root > div:not(.outline-3)'), new $.SectionSlide_hide_anon());
},
 show$0: function() {
  $.forEach(this.element.queryAll$1(':root > div:not(.outline-3)'), new $.SectionSlide_show_anon());
},
 updateTOC$0: function() {
  $.forEach($.document().queryAll$1('#text-table-of-contents > ul > li.toc-highlight'), new $.SectionSlide_updateTOC_anon());
  $.forEach($.document().queryAll$1('#text-table-of-contents > ul > li > ul > li.toc-highlight'), new $.SectionSlide_updateTOC_anon0());
  $.add$1(this.tocListItem.get$classes(), 'toc-highlight');
}
};
...
$$.SubSectionSlide = {"":
 ...
 makeCurrent$0: function() {
  this.element.get$classes().remove$1('hidden');
  this.updateTOC$0();
  this.resetPositionClassTo$1('current');
},
 makeNext$0: function() {
 ...
 updateTOC$0: function() {
  $.forEach($.document().queryAll$1('#text-table-of-contents > ul > li.toc-highlight'), new $.SubSectionSlide_updateTOC_anon(this));
  $.forEach($.document().queryAll$1('#text-table-of-contents > ul > li > ul > li.toc-highlight'), new $.SubSectionSlide_updateTOC_anon0());
  $.add$1(this.tocListItem.get$classes(), 'toc-highlight');
}
};

$$.SlideController = {"":
 ["slides?", "toc", "cursor!", "bonusClasses", "slideCounter"],
 "super": "Object",
 shortenTOC$0: function() {
  $.forEach($.document().queryAll$1('#text-table-of-contents > ul > li > ul > li > a'), new $.SlideController_shortenTOC_anon());
  $.document().query$1('#text-table-of-contents').insertAdjacentElement$2('AfterEnd', this.slideCounter);
},
 addEventListeners$0: function() {
  $.add$1($.document().get$on().get$keyDown(), new $.SlideController_addEventListeners_anon(this));
  $.add$1($.window().get$on().get$hashChange(), new $.SlideController_addEventListeners_anon0(this));
},
 toggleCodeHighlight$0: function() {
  var t1 = this.slides;
  var t2 = this.cursor;
  if (t2 !== (t2 | 0))
    throw $.iae(t2);
  if (t2 < 0 || t2 >= t1.length)
    throw $.ioore(t2);
  var offCode = t1[t2].get$element().queryAll$1('.coderef-off');
  var t3 = this.cursor;
  if (t3 !== (t3 | 0))
    throw $.iae(t3);
  if (t3 < 0 || t3 >= t1.length)
    throw $.ioore(t3);
  var onCode = t1[t3].get$element().queryAll$1('.code-highlighted');
  $.forEach(offCode, new $.SlideController_toggleCodeHighlight_anon());
  $.forEach(onCode, new $.SlideController_toggleCodeHighlight_anon0());
},
 addSlides$0: function() {
  $.forEach($.document().queryAll$1('.outline-2,.outline-3'), new $.SlideController_addSlides_anon(this));
},
 updateHash$0: function() {
  ...
  if (t2 < 0 || t2 >= t1.length)
    throw $.ioore(t2);
  var currentSlide = t1[t2];
  if (!(currentSlide == null)) {
    currentSlide.getSecID$0();
    t2 = $.S($.add(this.cursor, 1)) + ' / ' + $.S(t1.length);
    this.slideCounter.set$innerHTML(t2);
    t2 = currentSlide.getSecID$0();
    $.window().get$location().set$hash(t2);
  }
},
 updateCursorFromHash$0: function() {
  for (var t1 = this.slides, i = 0; i < t1.length; ++i)
    if ($.eqB(t1[i].getSecID$0(), $.window().get$location().get$hash()))
      this.cursor = i;
},
 nextSlide$0: function() {
  if ($.ltB($.add(this.cursor, 1), this.slides.length)) {
    this.cursor = $.add(this.cursor, 1);
    this.updateHash$0();
  }
},
 prevSlide$0: function() {
  if ($.gtB(this.cursor, 0)) {
    this.cursor = $.sub(this.cursor, 1);
    this.updateHash$0();
  }
},
 updateSlideClasses$0: function() {
  for (var t1 = this.slides, i = 0; i < t1.length; ++i) {
    var t2 = this.cursor;
    if (typeof t2 !== 'number')
      throw $.iae(t2);
 ...
 addInFunction$2: function(className, inFunction) {
  $.forEach($.filter(this.slides, new $.SlideController_addInFunction_anon(className)), new $.SlideController_addInFunction_anon0(inFunction));
},
 addOutFunction$2: function(className, outFunction) {
  $.forEach($.filter(this.slides, new $.SlideController_addOutFunction_anon(className)), new $.SlideController_addOutFunction_anon0(outFunction));
},
 startSlideShow$0: function() {
  this.shortenTOC$0();
  this.updateCursorFromHash$0();
  this.updateSlideClasses$0();
},
 SlideController$0: function() {
  this.addSlides$0();
  this.addEventListeners$0();
  this.slideCounter.set$id('slide-counter');
}
};
...
$$.SlideController_shortenTOC_anon = {"":
 [],
 "super": "Closure",
...
$$.SlideController_addOutFunction_anon = {"":
 ["className_0"],
 "super": "Closure",
 call$1: function(slide) {
  return $.contains$1(slide.get$element().get$classes(), this.className_0);
}
};

$$.SlideController_addOutFunction_anon0 = {"":
 ["outFunction_1"],
 "super": "Closure",
 call$1: function(slide) {
  $.add$1(slide.get$outFunctions(), this.outFunction_1);
}
};
...
$$.SlideController_addInFunction_anon = {"":
 ["className_0"],
 "super": "Closure",
 call$1: function(slide) {
  return $.contains$1(slide.get$element().get$classes(), this.className_0);
...
$$.SlideController_addInFunction_anon0 = {"":
 ["inFunction_1"],
 "super": "Closure",
 call$1: function(slide) {
  $.add$1(slide.get$inFunctions(), this.inFunction_1);
}
};

$$.SlideController_addEventListeners_anon = {"":
 ["this_0"],
 "super": "Closure",
 call$1: function(event$) {
  switch (event$.get$keyCode()) {
    ...
    case 33:
      ...
      break;
    case 72:
      this.this_0.toggleCodeHighlight$0();
      break;
    case 36:
      var t1 = this.this_0;
      t1.set$cursor(-1);
    ...
    case 35:
      t1 = this.this_0;
      t1.set$cursor($.sub($.get$length(t1.get$slides()), 2));
      t1.nextSlide$0();
      break;
    default:
      break;
...
$$.SlideController_addEventListeners_anon0 = {"":
 ["this_1"],
 "super": "Closure",
 call$1: function(event$) {
  var t1 = this.this_1;
  t1.updateCursorFromHash$0();
  t1.updateSlideClasses$0();
}
};

$$.SlideController_toggleCodeHighlight_anon = {"":
 [],
 "super": "Closure",
 call$1: function(element) {
  element.get$classes().remove$1('coderef-off');
  $.add$1(element.get$classes(), 'code-highlighted');
}
};

$$.SlideController_toggleCodeHighlight_anon0 = {"":
 [],
 "super": "Closure",
 call$1: function(element) {
  element.get$classes().remove$1('code-highlighted');
  $.add$1(element.get$classes(), 'coderef-off');
}
};

$$.SlideController_addSlides_anon = {"":
 ["this_0"],
 "super": "Closure",
 call$1: function(element) {
  if ($.contains$1(element.get$classes(), 'outline-2') === true)
    var slide = $.SectionSlide$(element);
  else if ($.contains$1(element.get$classes(), 'outline-3') === true)
    slide = $.SubSectionSlide$(element);
  else
    throw $.$$throw($.IndexOutOfRangeException$('Cannot find the required class (outline-2 or outline-3) in element: ' + $.S(element)));
  $.add$1(this.this_0.get$slides(), slide);
}
};

$$.AbstractSlide_resetPositionClassTo_anon = {"":
 ["this_0"],
 "super": "Closure",
 call$1: function(func) {
  return func.call$1(this.this_0.get$element());
}
};

$$.AbstractSlide_resetPositionClassTo_anon0 = {"":
 ["this_1"],
 "super": "Closure",
 call$1: function(func) {
  return func.call$1(this.this_1.get$element());
}
};

$$.SubSectionSlide_updateTOC_anon = {"":
 ["this_0"],
 "super": "Closure",
 call$1: function(element) {
  var t1 = this.this_0;
  if (!$.eqB(element, t1.get$tocListItem().get$parent().get$parent())) {
    element.get$classes().remove$1('toc-highlight');
    $.add$1(t1.get$tocListItem().get$parent().get$parent().get$classes(), 'toc-highlight');
  }
}
};

$$.SubSectionSlide_updateTOC_anon0 = {"":
 [],
 "super": "Closure",
 call$1: function(element) {
  element.get$classes().remove$1('toc-highlight');
...
$$.SectionSlide_hide_anon = {"":
 [],
 "super": "Closure",
 call$1: function(element) {
  $.add$1(element.get$classes(), 'hidden');
}
};

$$.SectionSlide_show_anon = {"":
 [],
 "super": "Closure",
 call$1: function(element) {
  element.get$classes().remove$1('hidden');
}
};

$$.SectionSlide_updateTOC_anon = {"":
 [],
 "super": "Closure",
 call$1: function(element) {
  element.get$classes().remove$1('toc-highlight');
...
$$.SectionSlide_hideSubsections_anon = {"":
 [],
 "super": "Closure",
 call$1: function(subSection) {
  $.add$1(subSection.get$classes(), 'hidden');
}
};
...
$.sootheOut = function(outboundSlide) {
  return $.document().get$body().get$classes().remove$1('soothe');
};
...
$.main = function() {
  ...
  controller.addInFunction$2('alert', $.alertIn);
  controller.addOutFunction$2('alert', $.alertOut);
  controller.addInFunction$2('soothe', $.sootheIn);
  controller.addOutFunction$2('soothe', $.sootheOut);
  controller.addInFunction$2('outline-2', $.sectionIn);
  controller.addOutFunction$2('outline-2', $.sectionOut);
  controller.startSlideShow$0();
};
...
$.sootheIn = function(inboundSlide) {
  return $.add$1($.document().get$body().get$classes(), 'soothe');
};
...
$.sectionOut = function(outboundSlide) {
  return $.document().get$body().get$classes().remove$1('section-title');
};
...
$.SectionSlide$ = function(element) {
  var t1 = new $.SectionSlide(null, null, ['far-past', 'past', 'next', 'far-next', 'current'], $.Set_Set(), $.Set_Set());
  t1.AbstractSlide$1(element);
  return t1;
};
...
$.alertOut = function(outboundSlide) {
  return $.document().get$body().get$classes().remove$1('alert');
};
...
$.sectionIn = function(inboundSlide) {
  return $.add$1($.document().get$body().get$classes(), 'section-title');
};
...
$.SubSectionSlide$ = function(element) {
  var t1 = new $.SubSectionSlide(null, null, ['far-past', 'past', 'next', 'far-next', 'current'], $.Set_Set(), $.Set_Set());
  t1.AbstractSlide$1(element);
  return t1;
};
...
$.SlideController$ = function() {
  var t1 = new $.SlideController([], [], -1, $.HashMapImplementation$(), $.DivElement_DivElement());
  t1.SlideController$0();
  return t1;
};
...
$.alertIn = function(inboundSlide) {
  return $.add$1($.document().get$body().get$classes(), 'alert');
};
...
$.alertIn.call$1 = $.alertIn;
$.alertIn.$name = "alertIn";
$.constructorNameFallback.call$1 = $.constructorNameFallback;
$.constructorNameFallback.$name = "constructorNameFallback";
$.typeNameInIE.call$1 = $.typeNameInIE;
$.typeNameInIE.$name = "typeNameInIE";
$.sectionIn.call$1 = $.sectionIn;
$.sectionIn.$name = "sectionIn";
$.dynamicBind.call$4 = $.dynamicBind;
$.dynamicBind.$name = "dynamicBind";
$.typeNameInFirefox.call$1 = $.typeNameInFirefox;
$.typeNameInFirefox.$name = "typeNameInFirefox";
$.sectionOut.call$1 = $.sectionOut;
$.sectionOut.$name = "sectionOut";
$.typeNameInSafari.call$1 = $.typeNameInSafari;
$.typeNameInSafari.$name = "typeNameInSafari";
$.sootheIn.call$1 = $.sootheIn;
$.sootheIn.$name = "sootheIn";
$.typeNameInChrome.call$1 = $.typeNameInChrome;
$.typeNameInChrome.$name = "typeNameInChrome";
$.invokeClosure.call$5 = $.invokeClosure;
$.invokeClosure.$name = "invokeClosure";
$.sootheOut.call$1 = $.sootheOut;
$.sootheOut.$name = "sootheOut";
$.typeNameInOpera.call$1 = $.typeNameInOpera;
$.typeNameInOpera.$name = "typeNameInOpera";
$.alertOut.call$1 = $.alertOut;
$.alertOut.$name = "alertOut";
...
$.CTC41 = 'structured clone of ImageData';
...
$.$defineNativeClass('HTMLDocument', ["body?"], {
 ...
 queryAll$1$bailout: function(state, env0) {
  ...
  switch (state) {
    case 0:
    default:
      if (state === 1 || state === 0 && $.CTC15.hasMatch$1(selectors) === true)
        switch (state) {
          case 0:
            var mutableMatches = this.$dom_getElementsByName$1($.substring$2(selectors, 7, selectors.length - 2));
          case 1:
        ...
        switch (state) {
          case 0:
          case 2:
            if (state === 2 || state === 0 && $.CTC16.hasMatch$1(selectors) === true)
              switch (state) {
                case 0:
                  mutableMatches = this.$dom_getElementsByTagName$1(selectors);
                case 2:
...
//@ sourceMappingURL=presorg.dart.js.map